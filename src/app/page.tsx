...
export default function HomePage() {
  return (
    <div className="flex flex-col items-center space-y-12">
      ...
      <section className="w-full max-w-4xl mt-16 py-8 border-t animate-fade-in" style={{animationDelay: '0.4s'}}>
        <h2 className="text-3xl font-headline text-center mb-8">How It Works</h2>
        <div className="grid md:grid-cols-3 gap-8 text-center">
          <div className="flex flex-col items-center p-4 rounded-lg hover:shadow-lg transition-shadow duration-300 animate-slide-in-up" style={{animationDelay: '0.5s'}}>
          ...
          <div className="flex flex-col items-center p-4 rounded-lg hover:shadow-lg transition-shadow duration-300 animate-slide-in-up" style={{animationDelay: '0.6s'}}>
            <div className="p-4 bg-primary/10 rounded-full mb-4">
          ...
          <div className="flex flex-col items-center p-4 rounded-lg hover:shadow-lg transition-shadow duration-300 animate-slide-in-up" style={{animationDelay: '0.7s'}}>
             <div className="p-4 bg-primary/10 rounded-full mb-4">
